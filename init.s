...
.LM50:
	xorl	%eax, %eax
	.stabn	68,0,69,.LM51-.LFBB3
.LM51:
	movl	$48, 12(%rsp)
	.stabn	68,0,70,.LM52-.LFBB3
.LM52:
	call	cprintf@PLT
	.stabn	68,0,71,.LM53-.LFBB3
.LM53:
	movq	%rbx, %rdi
	leaq	8(%rsp), %rsi
	call	vcprintf@PLT
	.stabn	68,0,72,.LM54-.LFBB3
.LM54:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM63:
	call	cprintf@PLT
	.stabn	68,0,89,.LM64-.LFBB4
.LM64:
	leaq	8(%rsp), %rsi
	movq	%rbx, %rdi
	call	vcprintf@PLT
	.stabn	68,0,90,.LM65-.LFBB4
.LM65:
	leaq	.LC4(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,92,.LM66-.LFBB4
.LM66:
	addq	$208, %rsp
	.cfi_def_cfa_offset 16
	popq	%rbx
